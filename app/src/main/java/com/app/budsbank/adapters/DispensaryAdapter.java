...
public class DispensaryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DispensaryAdapter() {

    }

    public DispensaryAdapter(Context context, ArrayList<DispensaryModel> data, String isFrom) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder = new DispensaryAdapter.ViewHolder(view);
        return holder;
    }
